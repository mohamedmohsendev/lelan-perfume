...
export const AnalyticsDashboard: React.FC = () => {
    ...
    const kpiStats = useMemo(() => {
        ...
        const totalRevenue = dailySales.reduce((sum: number, d: any) => sum + (Number(d.revenue) || 0), 0);
        const totalOrders = dailySales.reduce((sum: number, d: any) => sum + (Number(d.total_orders) || 0), 0);
